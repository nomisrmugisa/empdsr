	...
	MERGE INTO datamap(map_feature,map_value,map_label) KEY(map_feature,map_value) values('babyoutcome_options_ext',2,'Single very early neonatal death within 0-7days');
	...
	MERGE INTO datamap(map_feature,map_value,map_label) KEY(map_feature,map_value) values('babyoutcome_options_ext',6,'Multiple with one or more very early neonatal death (within 0-7days)');
	...
	MERGE INTO datamap(map_feature,map_value,map_label) KEY(map_feature,map_value) values('resctdone_options',3,'Trainee');
