...
public class PreDataConfig {
	...
	public void preloadingDatabase() {
		...
		
		{
			...
			res.add(new resuscitation_table("Advanced resuscitation with adrenaline","Advanced resuscitation with adrenaline"));
		...
		
		{
			...
			res.add(new mcondition_table("M3.2","M3","other malpresentation, malposition and disproportion during labour and delivery"));
		...
		
		{
			...
			res.add(new cfactor_table(301,300,"ANC routine labs not done due to shortages (Hb, Syphilis, Blood Grp etc.)"));
			res.add(new cfactor_table(302,300,"Inadequate facilities / resuscitation equipment in neonatal unit / Nursery"));
			...
			res.add(new cfactor_table(305,300,"Personnel insufficiently trained or too junior to manage the patient"));
			...
			res.add(new cfactor_table(402,400,"Inappropriate management of complications when they set in during antepartum period"));
			...
			res.add(new cfactor_table(409,400,"Foetal distress not detected during ANC or intrapartum, foetus not monitored"));
			res.add(new cfactor_table(410,400,"Foetal distress not detected during ANC or intrapartum, foetus monitored"));
			...
			res.add(new cfactor_table(414,400,"Physical examination of the patient at the clinic/hospital incomplete"));
			res.add(new cfactor_table(415,400,"Management of the second stage prolonged with no intervention"));
			res.add(new cfactor_table(416,400,"Management of the second stage prolonged with inappropriate intervention(s)"));
		...
		
		{
		    ...
		    res.add(new monitoring_table(10,"Total Deliveries",100,"Total deliveries","mothers who gave birth",true));
		    res.add(new monitoring_table(10,"Total Deliveries",101,"SVDs/NVDs","none",false));
		    res.add(new monitoring_table(10,"Total Deliveries",102,"Assisted (forceps, vacuum, etc)","none",false));
		    res.add(new monitoring_table(10,"Total Deliveries",103,"Caesarean Sections","none",false));
		    
		    res.add(new monitoring_table(11,"Total Births",110,"Total births","babies born - livebirths and stillbirths",true));
		    ...
		    res.add(new monitoring_table(12,"Stillbirths",120,"Total stillbirths","Total babies born dead after 28 weeks gestation",true));
		    res.add(new monitoring_table(12,"Stillbirths",121,"Antepartum or Macerated Stillbirths  (died  before labour started)","none",false));
		    res.add(new monitoring_table(12,"Stillbirths",122,"Intrapartum or Fresh Stillbirth (died during labour)","none",false));
		    
		    res.add(new monitoring_table(13,"Livebirths",130,"Total livebirths","Total babies alive at birth",true));
		    res.add(new monitoring_table(13,"Livebirths",131,"Term births (37 completed weeks or more)","none",false));
		    res.add(new monitoring_table(13,"Livebirths",132,"Preterms (less than 37 completed weeks)","none",false));
		    res.add(new monitoring_table(14,"Livebirths",133,"<i class=\"text-primary\">Very Preterms (less than 34 completed weeks)</i>","Very Preterms (less than 34 completed weeks)",false));
		    
		    res.add(new monitoring_table(13,"Birthweight",136,"Normal birthweight babies (2.5kg or more)","none",false));
		    res.add(new monitoring_table(13,"Birthweight",137,"Low birthweight babies (less than 2.5kg)","none",false));
		    res.add(new monitoring_table(14,"Birthweight",138,"<i class=\"text-primary\">Very low birthweight babies (less than 1.5kg)</i>","Very low birthweight babies (less than 1.5kg)",false));
		    res.add(new monitoring_table(14,"Birthweight",139,"<i class=\"text-primary\">Extremely low birthweight babies (less than 1.0kg)</i>","Extremely low birthweight babies (less than 1.0kg)",false));
		    
		    res.add(new monitoring_table(15,"Neonatal deaths",150,"Neonatal deaths","live born babies who died within 28 days",true));
		    res.add(new monitoring_table(15,"Neonatal deaths",151,"Early Neonatal Deaths (1-7 days)","none",false));
		    res.add(new monitoring_table(15,"Neonatal deaths",152,"Late Neonatal Deaths (8-28 days)","none",false));
		...
		
		{
			...
			res.add(new datamap("mode_options",2,"Caesarean Section"));
			...
			res.add(new datamap("babyoutcome_options_ext",6,"Multiple with one or more very early neonatal death (within 24hrs)"));
