...
public class ServiceApi {
	...
	private String DHIS2_API_URL, DHIS2_API_USERNAME, DHIS2_API_PASSWORD;

	private final RestTemplateBuilder builder;

	public ServiceApi(final RestTemplateBuilder builder) {
	...
	public List<json_redcap> extractRedCapIdentifiers(Date startDate, Date endDate) {
		...
		try {
			...
			ResponseEntity<List<json_redcap>> response = builder.build().exchange(API_URL, HttpMethod.POST, request,
...
//			final String baseUrl = "https://hmis-tests.health.go.ug";
//			ResponseEntity<String> me = rt.getForEntity(baseUrl + "/api/me", String.class);
//			System.out.println(me.getStatusCode());       // expect 200
