...
public class sync_table implements Serializable {
	...
	@Column
	private String sync_dhis2_url;
	
	@Column
	private Double sync_dhis2_longitude;
	
	@Column
	private Double sync_dhis2_latitude;
	...
	public String getSync_dhis2_url() {
		return sync_dhis2_url;
	}

	public void setSync_dhis2_url(String sync_dhis2_url) {
		this.sync_dhis2_url = sync_dhis2_url;
	}

	public Double getSync_dhis2_longitude() {
		return sync_dhis2_longitude;
	}

	public void setSync_dhis2_longitude(Double sync_dhis2_longitude) {
		this.sync_dhis2_longitude = sync_dhis2_longitude;
	}

	public Double getSync_dhis2_latitude() {
		return sync_dhis2_latitude;
	}

	public void setSync_dhis2_latitude(Double sync_dhis2_latitude) {
		this.sync_dhis2_latitude = sync_dhis2_latitude;
	}
