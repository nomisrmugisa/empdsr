...
public class DecryptedAuditRecommendation implements Serializable {
	...
	private json_audit_recommendation selected;
	private List<json_audit_recommendation> data;

	public DecryptedAuditRecommendation() {
	}
	
	public DecryptedAuditRecommendation(json_audit_recommendation selected) {
	...
	public json_audit_recommendation getSelected() {
		return selected;
	}

	public void setSelected(json_audit_recommendation selected) {
		this.selected = selected;
	}

	public List<json_audit_recommendation> getData() {
		return data;
	}

	public void setData(List<json_audit_recommendation> data) {
		this.data = data;
	}
