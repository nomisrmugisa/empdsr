...
public class json_list implements Serializable {
	...
	private List<json_data> biodata, pregnancy, referral, delivery, antenatal, labour, mdeath, birth, fetalheart,
			babydeath, notes;
	...
	public List<json_data> getBabydeath() {
		return babydeath;
	}

	public void setBabydeath(List<json_data> babydeath) {
